...
<body>
    ...
    <div style="width: 300px;margin:10px auto 0;padding: 20px;background-color: #ffffff;border: 1px solid #ccc;border-radius: 5px;">
        <form action="/layout/login" method="post" style="font-size: 24px;text-align: center;">
            ...
            ユーザ名 ：<input type="text" name="username" style=" width:30%;padding: 10px;margin-bottom: 10px;border: 1px solid #ccc;border-radius: 4px;"><br>
            パスワード：<input type="text" name="password" style=" width: 30%;padding: 10px;margin-bottom: 10px;border: 1px solid #ccc;border-radius: 4px;"><br>
